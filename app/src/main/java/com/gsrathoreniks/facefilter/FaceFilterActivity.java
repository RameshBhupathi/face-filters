...
public class FaceFilterActivity extends AppCompatActivity {
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            try {
                ...
                if (image != null) {
                    ...
                    File file = new File(STORE_DIRECTORY + "/myscreen_" + IMAGES_PRODUCED + ".png");
    ...
    public void onCreate(Bundle icicle) {
        ...
        topView = (RelativeLayout) findViewById(R.id.topLayout);
    ...
    public void showDialog(final Uri fileUri) {
    ...
    private void shareBitmap(Uri fileUri) {
